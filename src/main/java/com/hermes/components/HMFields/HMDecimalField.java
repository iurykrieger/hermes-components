 ...
 * @author iury
 */
public class HMDecimalField extends JFormattedTextField {

    private static final NumberFormat DECIMAL_FORMAT = new DecimalFormat("######0.00 mm");
    private NumberFormat numberFormat;
    private int limit = 16;

    public HMDecimalField(int casasDecimais) {
        this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
        Dimension dm = new Dimension(150, 26);
        this.setPreferredSize(dm);
    }

    public HMDecimalField() {
        this(DECIMAL_FORMAT);
        Dimension dm = new Dimension(150, 26);
        this.setPreferredSize(dm);
    }
    
    public HMDecimalField(String mask){
        this(new DecimalFormat(mask));
        Dimension dm = new Dimension(150,26);
        this.setPreferredSize(dm);
    }

    public HMDecimalField(NumberFormat format) {
        Dimension dm = new Dimension(150, 26);
        this.setPreferredSize(dm);
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(HMDecimalField.this.getText().replaceAll("[^0-9]", "")).append(
